package com.tanliwei.conterller;
...
public class AudioModelController {
    ...
    private static final String PATH="src/main/resources/audio/";
    @Autowired
    ...
    public void tts(){
        //创建
        DashScopeSpeechSynthesisOptions op = DashScopeSpeechSynthesisOptions.builder()
                .withSpeed(1.0)
                .withPitch(0.9)
                .withVolume(60)
                .build();
        ...
        SpeechSynthesisResponse response = speechSynthesisModel.call(
                new SpeechSynthesisPrompt(TEXT, op)
        );
